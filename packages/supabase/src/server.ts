...
// `createServiceRoleClient` was a Phase 2 alias of `createAdminClient` —
// same key, same options, different name. Convergence to the older name
// landed in plan 06-03; consumers now import from `@repo/supabase/admin`.
