-- ───────────────────────────────────────────────────────────────────────────
-- Plan 07-06 — Supabase Advisor Sweep (migration 00019)
--
-- Closes Tier 1 of the advisor triage in `.planning/phases/07-rollout/07-06-PLAN.md`.
-- Applied via MCP `apply_migration` against project tgswsdfaszvztbpczfve;
